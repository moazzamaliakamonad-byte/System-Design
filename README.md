...
| Category | Topics |
|---|---|
| **Fundamentals** | Storage, Scalability, Networking Protocols, Load Balancing & Proxies, Latency, Throughput & Performance, CAP Theorem, ACID vs BASE |
...
│   ├── 2-Scalability.html
│   ├── 3-protocols.html
│   ├── 3(2nd)-LoadBalancing-Proxies.html
│   └── 4-Latency-Throughput.html
├── networking/
│   └── ...
├── databases/
│   └── ...
